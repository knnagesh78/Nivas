...
export default function LostFoundFeed({ initialSelectedItem = null, onClearSelectedItem = null }) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 border border-indigo-400/30 rounded-3xl p-6 sm:p-7 shadow-xl text-white relative overflow-hidden">
        <div className="flex items-center space-x-4 relative z-10">
          <div className="h-12 w-12 rounded-2xl bg-white/20 border border-white/30 flex items-center justify-center text-white shadow-xs flex-shrink-0">
